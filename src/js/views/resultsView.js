...
// we export here the instance from the class ResultsView and not the class itself and because it is default, it would be only one default Instance, because every class can have only one default for export and not more and can have much more normal export(not export default)!
